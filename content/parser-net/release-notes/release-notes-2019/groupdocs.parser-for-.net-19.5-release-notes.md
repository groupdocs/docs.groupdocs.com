...
1.  ### Implement the ability to extract data from documents
    ...
    *   The position is set relative to the related field (Related)
    ...
    <table class="confluenceTable"><tbody><tr><td class="confluenceTd"><img class="confluence-embedded-image" src="attachments/84967625/85098547.png" data-image-src="attachments/84967625/85098547.png"></td><td class="confluenceTd"><p>Extracts a text on the right of "Invoice Number" field:</p><p>INV-3337</p></td></tr></tbody></table>
    ...
    <table class="confluenceTable"><tbody><tr><td class="confluenceTd"><img class="confluence-embedded-image" src="attachments/84967625/85098548.png" data-image-src="attachments/84967625/85098548.png">&nbsp;</td><td class="confluenceTd"><p>Extracts a text on the right of "Invoice Number" field:</p><p>INV-3337</p></td></tr></tbody></table>
    ...
    *   Bottom: (RelatedField.Rectangle.Left; RelatedField.Rectangle.Bottom)
    ...
    <table class="confluenceTable"><tbody><tr><td class="confluenceTd"><img class="confluence-embedded-image" src="attachments/84967625/85098549.png" data-image-src="attachments/84967625/85098549.png"></td><td class="confluenceTd"><p>The extraction is processed in the following way:</p><ol><li>Extracts data of "From" regex field (green)</li><li>Extracts data of "FromCompany" related field (yellow)</li><li>Extracts data of "FromAddress" related field (red)</li></ol></td></tr></tbody></table>
