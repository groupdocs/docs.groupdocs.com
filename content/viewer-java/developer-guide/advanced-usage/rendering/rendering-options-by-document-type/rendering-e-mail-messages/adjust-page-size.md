...
hideChildren: False
---
[**GroupDocs.Viewer**](https://products.groupdocs.com/viewer/java) allows setting output page size for rendering Email messages into HTML, PDF, and images. To enable this feature, the setter *htmlViewOptions.get**EmailOptions.set*PageSize()** is used. The following are the pages sizes that are supported and provided in *PageSize Enumeration*:
...
*   Set *htmlViewOptions.get**EmailOptions().setPageSize()*
*   Call v*iew() *method  
