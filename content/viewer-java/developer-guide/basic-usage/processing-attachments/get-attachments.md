---
id: get-attachments
url: viewer/java/get-attachments
...
hideChildren: False
---
[**GroupDocs.Viewer**](https://products.groupdocs.com/viewer/java) for Java API enables you to to retrieve a list of document attachments from your emails, Outlook data files, archives and PDF documents.
...
The following example demonstrates how to get all attachments from MSG file.
