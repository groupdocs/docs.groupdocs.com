...
<div class="gdoc-columns gdoc-columns--regular flex flex-gap flex-mobile-column">
    <div class="gdoc-columns__content gdoc-markdown--nested flex-even"><a class="home-resource-link" rel="nofollow"
            ...
            </svg><br>API Reference</a></div>
    <div class="gdoc-columns__content gdoc-markdown--nested flex-even"><a class="home-resource-link" rel="nofollow"
            href="https://groupdocs.github.io/"><svg class="gdoc-icon gdoc-icon-large code">
                <use xlink:href="#code"></use>
            </svg><br>Code Samples</a></div>
    <div class="gdoc-columns__content gdoc-markdown--nested flex-even"><a class="home-resource-link" rel="nofollow"
            href="https://groupdocs-free-consulting.github.io/"><svg class="gdoc-icon gdoc-icon-large headset">
                <use xlink:href="#headset"></use>
            </svg><br>Free Consulting</a></div>
    <div class="gdoc-columns__content gdoc-markdown--nested flex-even"><a class="home-resource-link" rel="nofollow"
            href="https://forum.groupdocs.com/"><svg class="gdoc-icon gdoc-icon-large user">
                <use xlink:href="#user"></use>
            </svg><br>Free Support</a></div>
    <div class="gdoc-columns__content gdoc-markdown--nested flex-even"><a class="home-resource-link" rel="nofollow"
            href="https://groupdocsapp.github.io/"><svg class="gdoc-icon gdoc-icon-large desktop">
                <use xlink:href="#desktop"></use>
            </svg><br>Live Demos</a></div>
    <div class="gdoc-columns__content gdoc-markdown--nested flex-even"><a class="home-resource-link" rel="nofollow"
            href="https://helpdesk.groupdocs.com/"><svg class="gdoc-icon gdoc-icon-large user-tie">
    ...
    <div class="gdoc-columns__content gdoc-markdown--nested flex-even">
        <div class="gdoc-page__anchorwrap">
            <h3 id="a-classhome-resource-link-relnofollow-hrefhttpsdocsgroupdocscomtotalgroupdocstotal-product-familya">
                <a class="home-resource-link" rel="nofollow" href="https://docs.groupdocs.com/total">GroupDocs.Total
                    Product Family</a></h3>
        </div>
        <p>Manipulate documents from within your own desktop solutions and web apps without requiring any other
            commercial products</p><span class="gdoc-button gdoc-button--large"><a class="gdoc-button__link"
                href="https://docs.groupdocs.com/total/net"><svg class="gdoc-icon gdoc-icon-large windows">
                    <use xlink:href="#windows"></use>
                </svg>.NET</a></span>
        <span class="gdoc-button gdoc-button--large"><a class="gdoc-button__link"
                href="https://docs.groupdocs.com/total/java"><svg class="gdoc-icon gdoc-icon-large java">
...
<div class="gdoc-columns gdoc-columns--regular flex flex-gap flex-mobile-column">
    ...
    <div class="gdoc-columns__content gdoc-markdown--nested flex-even">
        ...
        <p>Powerful document annotator component that helps you to boost your applications with document annotation,
            commenting and collaboration features.</p><span class="gdoc-button gdoc-button--large"><a
                class="gdoc-button__link" href="https://docs.groupdocs.com/annotation/net"><svg
...
<div class="gdoc-columns gdoc-columns--regular flex flex-gap flex-mobile-column">
    ...
    <div class="gdoc-columns__content gdoc-markdown--nested flex-even">
        <div class="gdoc-page__anchorwrap">
            <h3
                id="a-classhome-resource-link-relnofollow-hrefhttpsdocsgroupdocscomassemblygroupdocsassembly-product-familya">
                <a class="home-resource-link" rel="nofollow"
                    href="https://docs.groupdocs.com/assembly">GroupDocs.Assembly Product Family</a></h3>
        </div>
        <p>Automate your document generation process with cross platform automation assembly APIs to boost productivity
            and accuracy</p><span class="gdoc-button gdoc-button--large"><a class="gdoc-button__link"
                href="https://docs.groupdocs.com/assembly/net"><svg class="gdoc-icon gdoc-icon-large windows">
                    <use xlink:href="#windows"></use>
                </svg>.NET</a></span>
        <span class="gdoc-button gdoc-button--large"><a class="gdoc-button__link"
                href="https://docs.groupdocs.com/assembly/java"><svg class="gdoc-icon gdoc-icon-large java">
                    <use xlink:href="#java"></use>
                </svg>Java</a></span>
    </div>
</div>
<div class="gdoc-columns gdoc-columns--regular flex flex-gap flex-mobile-column">
    <div class="gdoc-columns__content gdoc-markdown--nested flex-even">
        ...
        <p>Native .NET API to dynamically read, write, edit and remove meta information from Microsoft Office, PDF,
            Multimedia, images and various other file formats</p><span class="gdoc-button gdoc-button--large"><a
                class="gdoc-button__link" href="https://docs.groupdocs.com/metadata/net"><svg
                    class="gdoc-icon gdoc-icon-large windows">
                    <use xlink:href="#windows"></use>
                </svg>.NET</a></span>
        <span class="gdoc-button gdoc-button--large"><a class="gdoc-button__link"
                href="https://docs.groupdocs.com/metadata/java"><svg class="gdoc-icon gdoc-icon-large java">
                    <use xlink:href="#java"></use>
                </svg>Java</a></span>
    </div>
    <div class="gdoc-columns__content gdoc-markdown--nested flex-even">
...
<div class="gdoc-columns gdoc-columns--regular flex flex-gap flex-mobile-column">
    <div class="gdoc-columns__content gdoc-markdown--nested flex-even">
        <div class="gdoc-page__anchorwrap">
            <h3
                id="a-classhome-resource-link-relnofollow-hrefhttpsdocsgroupdocscomparsergroupdocsparser-product-familya">
                <a class="home-resource-link" rel="nofollow" href="https://docs.groupdocs.com/parser">GroupDocs.Parser
                    Product Family</a></h3>
        </div>
        <p>Parse, extract images, raw &amp; formatted text with metadata and perform a lot of operations with it using
            APIs which work on all popular platforms and supported file formats</p><span
            class="gdoc-button gdoc-button--large"><a class="gdoc-button__link"
                href="https://docs.groupdocs.com/parser/net"><svg class="gdoc-icon gdoc-icon-large windows">
                    <use xlink:href="#windows"></use>
                </svg>.NET</a></span>
        <span class="gdoc-button gdoc-button--large"><a class="gdoc-button__link"
                href="https://docs.groupdocs.com/parser/java"><svg class="gdoc-icon gdoc-icon-large java">
                    <use xlink:href="#java"></use>
                </svg>Java</a></span>
    </div>
    <div class="gdoc-columns__content gdoc-markdown--nested flex-even">
...
<div class="gdoc-columns gdoc-columns--regular flex flex-gap flex-mobile-column">
    <div class="gdoc-columns__content gdoc-markdown--nested flex-even">
        ...
        <p>Build cross-platform applications that perform operations, such as, redacting, hiding, removing content and
            metadata from documents, presentations, worksheets and PDF files</p><span
            class="gdoc-button gdoc-button--large"><a class="gdoc-button__link"
                href="https://docs.groupdocs.com/redaction/net"><svg class="gdoc-icon gdoc-icon-large windows">
                    <use xlink:href="#windows"></use>
                </svg>.NET</a></span>
        <span class="gdoc-button gdoc-button--large"><a class="gdoc-button__link"
                href="https://docs.groupdocs.com/redaction/java"><svg class="gdoc-icon gdoc-icon-large java">
                    <use xlink:href="#java"></use>
                </svg>Java</a></span>
    </div>
    <div class="gdoc-columns__content gdoc-markdown--nested flex-even">
