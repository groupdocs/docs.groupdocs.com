...
The default synonym dictionary contains synonyms only for the English language. To manage the synonym dictionary, see the [Synonym search](Synonym%2Bsearch.html) page in the [Synonym search](Synonym%2Bsearch.html) section.
