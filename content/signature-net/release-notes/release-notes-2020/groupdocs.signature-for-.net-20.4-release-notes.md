...
[SIGNATURENET-2788](https://issue.lisbon.dynabic.com/issues/SIGNATURENET-2788)

Involve full featured JSON serialization and de-serialization support

Feature

[SIGNATURENET-2611](https://issue.lisbon.dynabic.com/issues/SIGNATURENET-2611)

Extend QR-code Signature with image data content

Feature

[SIGNATURENET-2610](https://issue.lisbon.dynabic.com/issues/SIGNATURENET-2610)

Extend Barcode Signature with image data content

Feature

[SIGNATURENET-2438](https://issue.lisbon.dynabic.com/issues/SIGNATURENET-2438)

[Implement ability to store creation and update date for signatures](https://issue.lisbon.dynabic.com/issues/SIGNATURENET-2438)

Feature

[SIGNATURENET-2794](https://issue.lisbon.dynabic.com/issues/SIGNATURENET-2794)

[Digital signatures are not valid for password protected PDF documents](https://issue.lisbon.dynabic.com/issues/SIGNATURENET-2794)

Bug

[SIGNATURENET-2793](https://issue.lisbon.dynabic.com/issues/SIGNATURENET-2793)

[Incorrect Text signature appearance with right allignment for PDF documents](https://issue.lisbon.dynabic.com/issues/SIGNATURENET-2793)

Bug

[/SIGNATURENET-2790](https://issue.lisbon.dynabic.com/issues/SIGNATURENET-2790)

[QR-Code signatures without left and top margins on image are not recognized](https://issue.lisbon.dynabic.com/issues/SIGNATURENET-2790)

Bug

[SIGNATURENET-2787](https://issue.lisbon.dynabic.com/issues/SIGNATURENET-2787)

[Exception occurs when creating QRCode signature with non latin char-set characters](https://issue.lisbon.dynabic.com/issues/SIGNATURENET-2787)
