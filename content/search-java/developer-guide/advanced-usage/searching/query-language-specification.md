...
hideChildren: False
---
The text below represents the complete specification of the search query DSL (Domain Specific Language) used in text queries. See also [Search operation table](Search%2Boperation%2Btable.html), [Search flow](Search%2Bflow.html).
