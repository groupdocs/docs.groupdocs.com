GroupDocs.Viewer for .NET : Rendering pages to the same size as the size of pages in a source document  

# GroupDocs.Viewer for .NET : Rendering pages to the same size as the size of pages in a source document

div.rbtoc1588850834781 { padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; }div.rbtoc1588850834781 ul { list-style-type: disc; list-style-image: none; margin-left: 0px; }div.rbtoc1588850834781 li { margin-left: 0px; padding-left: 0px; }
...
![](attachments/86999073/87359496.png)
